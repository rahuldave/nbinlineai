...
Public documentation in the current checkout: the [manual index](../docs/user-guide.md) links eight chapters, including [Context selection](../docs/manual/context-selection.md); the [FAQ](../docs/faq.md), [tools reference](../docs/tools.md), [examples](../docs/examples.md), [architecture](../docs/architecture.md), and [development guide](../docs/development.md) remain separate. This documentation-only split is not in the published PyPI 0.1.13 archives; the new site layout has not yet been verified as deployed. Update public instructions whenever a shipped feature changes; keep future proposals clearly labeled here.
